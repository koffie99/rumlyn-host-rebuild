...
const Login = () => {
      ...
      await fetch("https://api.rumlyn.com/api/v1/mega-login/", requestOptions)
        ...
        .then((result) => {
          if (result.msg === "login successful") {
            ...
            sessionStorage.setItem("creatorName", result.creator.name)
  ...
  return (
    <div className="min-h-screen w-full login-bg flex items-center justify-center gap-8 md:p-0 p-7">
      <div className="md:h-[80vh] h-fit 2xl:h-fit 2xl:pb-12 md:py-0 pb-12 md:flex-[0.5] 2xl:flex-[0.4] flex-1 rounded-lg bg-white shadow-2xl flex flex-col items-center">
        <Image
          width={100}
          height={100}
        ...
        <div className="mt-4 flex flex-col items-center">
          <h2 className="text-2xl 2xl:text-4xl">Welcome here</h2>
          <p className="text-sm 2xl:text-lg">Login to get your listings out there</p>
        </div>
